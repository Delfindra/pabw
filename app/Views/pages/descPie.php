    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4 desc-gmbr">
                <div>
                    <img src="<?php echo base_url('img/produk/Pie Susu 21 Bali Minipack_41k.png'); ?>" class="img-fluid float-start" alt="hero image" />
                </div>
            </div>
            <div class="col-md-5 align-self-center desc-deskripsi">
                <h6>SKU: PSB-026</h6>
                <h1 class="text-start judul">Pie Susu</h1>
                <h4>Rp 35.000</h4>
                <p class="text-start desk">
                    Pie susu adalah oleh-oleh yang terkenal khas dari Pulau Bali.<br>
                    Halal, enak dan lezat untuk dikonsumsi baik kalangan orang dewasa sampai ke anak-anak.<br>
                    Kemasan box isi 10pcs<br>
                    Varian rasa:<br>
                    • Original (Best Seller)<br>
                    • Keju (Best Seller)<br>
                    • Coklat<br>
                    • Durian (New Flavour)<br>
                    • Green Tea (New Flavour)<br>
                </p>
                <div class="btn">
                    <a href="/pages/cart">
    ...
    <div class="container">
        <div class="row">
            <div class="col related-top">
                ...
                <!-- <h6 class="titledesc">Lorem ipsum dolor sit amet, condotwetur adipisicing elit. Tempora pariatur repudiandae voluptatum!</h6> -->
            </div>
        </div>
        ...
        <div class="row my-3 justify-content-center related-row1">
            <div class="col-2 related-col">
                <div class="card">
                    ...
                    <div class="card-body bg-light">
                        <small class="small">Fashion</small>
            ...
            <div class="col-2 related-col">
                <div class="card">
                    ...
                    <div class="card-body bg-light">
                        <small class="small">Handicraft</small>
