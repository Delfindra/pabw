    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4 desc-gmbr">
                <div>
                    <img src="<?php echo base_url('img/produk/Baju Barong Lukis Pria Hijau_60k.png'); ?>" class="img-fluid float-start" alt="hero image" />
                </div>
            </div>
            <div class="col-md-5 align-self-center desc-deskripsi">
                <h6>SKU: KBG-162</h6>
                <h1 class="text-start judul">Baju Barong Lukis</h1>
                <h5>Rp 66.000</h5>
                <p class="text-start desk">
                    Product Detail :<br>
                    - Soft-touch jersey<br>
                    - Crew neck<br>
                    - Short sleeves<br>
                    - Waterbased Ink Print<br>
                    - Fixed cuffs<br>
                    - Regular fit<br>
                    - Machine wash<br>
                    - 100% Cotton Combed 30’s<br>
                </p>
                <div class="btn">
                    <a href="/pages/cart">
        ...
        <div class="row my-3 justify-content-center related-row1">
            ...
            <div class="col-2 related-col">
                <div class="card related-card">
                    ...
                    <div class="card-body bg-light">
                        <small class="related-small">Coffe</small>
